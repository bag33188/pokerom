...
const TWO_GIBIBYTES = 0x80000000; /* decimal value: 2147483648 */

data.forEach((seed) => {
    // determine which file-sizes in the seeds-data array need to be wrapped in mongodb `NumberLong` function
    // in order to cast int64 as `long` and not `double`
