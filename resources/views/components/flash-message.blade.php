@pushonce('scripts')
    <script type="text/javascript">
        ...
        const flashIsSetToOpen = (flashOpen) => flashOpen === true;
    </script>
@endpushonce
            ...
            @case('success')
                <div class="w-full flex justify-center">
                    <div
                        ...
                        role="alert" type="success" x-show="flashIsSetToOpen(flashOpen)">
            ...
            @case('error')
                <div class="w-full flex justify-center">
                    <div
                        ...
                        role="alert" type="error" x-show="flashIsSetToOpen(flashOpen)">
                        <button type="button" @click="flashOpen = false" class="text-red-500 float-right">X</button>
            ...
            @default
                <div class="w-full flex justify-center">
                    <div
                        ...
                        role="alert" type="info" x-show="flashIsSetToOpen(flashOpen)">
                        <button type="button" @click="flashOpen = false" class="text-red-500 float-right">X</button>
