...
<x-app-layout>
    ...
    <div class="py-6 px-5">
        <x-list-group class="shadow">
            <x-list-item><p class="mt-1.5 mb-2.5 inline-block">ROM Info</p>
                <x-list-group class="border-1 py-2 rounded-lg !bg-gray-100">
            ...
            @if($rom->has_game)
                <x-list-item><p class="mt-1.5 mb-2.5 inline-block">Game Info</p>
                    <x-list-group class="border-1 py-2 rounded-lg !bg-gray-100">
            ...
            @endif
            @if($rom->has_file)
                <x-list-item><p class="mt-1.5 mb-2.5 inline-block">File Info</p>
                    <x-list-group class="border-1 py-2 rounded-lg !bg-gray-100">
