...
<x-app-layout>
    ...
    <div class="py-6 px-5">
        <x-list-group class="shadow">
            <x-list-item><p class="mt-1.5 mb-3 inline-block">ROM Info</p>
            ...
            @if($rom->has_game)
                <x-list-item><p class="mt-1.5 mb-3 inline-block">Game Info</p>
                    <x-list-group class="-border border-1 rounded-lg !bg-gray-100">
            ...
            @endif
            @if($rom->has_file)
                <x-list-item><p class="mt-1.5 mb-3 inline-block">File Info</p>
                    <x-list-group class="-border border-1 rounded-lg !bg-gray-100">
