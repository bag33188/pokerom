                ...
                <div
                    ...
                    <section
                        ...
                        <div id="check-it-out-roms" class="mt-3.5 ml-11 inline-flex flex-row h-full items-end">
                            <x-anchor-button :btn-type="\App\Enums\AnchorTypeEnum::SECONDARY" href="{{ route('roms.index') }}" target="_self">
                    ...
                    <section
                        ...
                        <div id="check-it-out-games" class="mt-3 ml-11 inline-flex flex-row h-full items-end">
                            <x-anchor-button :btn-type="\App\Enums\AnchorTypeEnum::SECONDARY" href="{{ route('games.index') }}" target="_self">
